...
export const testimonials: ITestimonial[] = [
  ...
  },
  {
    name: "Jane Doe",
    role: "CTO at Startup",
    message: `It's rare to find an app that balances user-friendliness with such advanced technology.`,
  ...
  },
  {
    name: "John Smith",
    role: "CEO at Company",
    message: `It's an invaluable resource in the modern financial landscape.`,
    avatar: "/images/testimonial-1.webp",
  },
  {
    name: "Jane Doe",
  ...
  },
  {
    name: "Emily Johnson",
    role: "Product Manager",
    message: `Its intuitive design and powerful features make it an indispensable tool for anyone serious about financial growth.`,
    avatar: "/images/testimonial-3.webp",
  },
];
